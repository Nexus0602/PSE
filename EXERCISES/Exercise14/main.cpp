...
int main(int argc, char *argv[]){
    ...
    engine.world.emplace<NameGroupComponent>(a,"enemy ", "enemies");
    ...
    engine.world.emplace<NameGroupComponent>(c,"enemy ", "enemies");
    ...
    engine.world.emplace<NameGroupComponent>(d,"enemy ", "enemies");
    ...
    engine.world.emplace<NameGroupComponent>(b,"enemy ", "enemies");
    ...
    engine.world.emplace<NameGroupComponent>(e,"enemy ", "enemies");
    ...
    engine.world.emplace<NameGroupComponent>(f,"enemy ", "enemies");
